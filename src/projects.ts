const projects = [
  {
    ...
    "blurb": "An app for digitising benefit applications for the Czech Ministry of Work and Social Affairs.",
    "short_description": "An app for digitalizing benefit applications for the Czech Ministry of Labour and Social Affairs.",
    "long_description": "Jenda enables citizens to apply for various benefits from their home, saving them time and effort. Working on this project has been enriching, allowing me to collaborate with a large team and deal with complex data and forms.",
    ...
    "what_i_learned": "This project has been the most enriching experience for me. It's my first time working with a large team of analysts, UX designers, and engineers. I've also learned to work with shared components and handle complex forms using React Hook Form.",
  ...
  },
  {
    ...
    "long_description": "Wake on LAN @OKsystem is my first project as a front-end developer at OKsystem. It allows logged-in users to add, edit, and delete their computers and send a magic packet to wake up their computer remotely.",
