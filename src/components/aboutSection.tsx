                        ...
                        {isReadMoreVisible ? (
                            <>
                                <p className="text-m leading-8 text-gray-600">
                                    In 2021, I took a significant leap outside my comfort zone to specialise in the areas that truly captivate me: UX and front-end development. I possess a relentless appetite for learning, regardless of the industry. I'm adaptable, dependable, and a quick student. My voyage into front-end development was originally fueled by a personal project—an idea for a website mapping baby-friendly places. This drive led me to enrol in a rigorous three-month course, marking my entry into the world of IT.
                                </p>
                                <br/>
                                <p className="text-m leading-8 text-gray-600">
